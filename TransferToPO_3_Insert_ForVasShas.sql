...
--		Transfer To PO
-- =============================================
If Object_Id ( 'dbo.TransferToPO_3_Insert_ForVasShas', 'P' ) Is Not Null
    Drop Procedure dbo.TransferToPO_3_Insert_ForVasShas;
Go

Create Procedure [dbo].[TransferToPO_3_Insert_ForVasShas]
	(
...
Begin
	...
	Begin
		...
		Begin
			...
			Delete From #tmpPO_Supp_Detail_Spec Where ID = @PoID And Seq1 = @Seq1 And Seq2 = @Seq2;
			Delete From #tmpPO_Supp_Detail_Keyword Where ID = @PoID And Seq1 = @Seq1 And Seq2 = @Seq2;
		End;
		Else
		Begin
			If @Seq1 = 'A1'
	...
	Begin Try
		...
		Begin
			...
			Insert Into dbo.Po
				(ID, StyleUkey, BrandID, StyleID, SeasonId, POSMR, POHandle, PCSMR, PCHandle, ShipMark, FTYMark, AddName, AddDate)
			Values
				(@PoID, @StyleUkey, @BrandID, @StyleID, @SeasonId, @PoSMR, @PoHandle, @PoSMR, @PoHandle, @ShipMark, @FTYMark, @UserID, @NowDateTime);
		End;
		Else
		Begin
			If @AppType = 0
		...
		Begin
			...
			Begin
				Select @Seq2 = #tmpPO_Supp_Detail.Seq2
					 ...
					 --, @BomFactory = #tmpPO_Supp_Detail.BomFactory
					 --, @BomCountry = #tmpPO_Supp_Detail.BomCountry
					 --, @BomStyle = #tmpPO_Supp_Detail.BomStyle
					 --, @BomCustCD = #tmpPO_Supp_Detail.BomCustCD
					 --, @BomArticle = #tmpPO_Supp_Detail.BomArticle
					 , @BomZipperInsert = #tmpPO_Supp_Detail.BomZipperInsert
					 --, @BomBuymonth = #tmpPO_Supp_Detail.BomBuymonth
...
Go
Exec Trade.dbo.CopyProcedureToDataBase 'MemDB', 'TransferToPO_3_Insert_ForVasShas';
Go